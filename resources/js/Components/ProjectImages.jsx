...
const ProjectImages = ({ images, projectId, onImageDeleted, onImageAdded }) => {
    ...
    const handleRemove = async (imageId) => {
        ...
        try {
            const response = await axios.post(`/destroyProjectImage/${imageId}`);
    ...
    const handleImageChange = async (e) => {
        ...
        try {
            const response = await axios.post('/uploadProjectImage', formData); 
            if (response.status == 200) {
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="h-auto max-h-[275px] overflow-auto flex flex-col gap-4 w-full border border-gray-300 rounded-md shadow-sm py-2 px-3">
